...
ggplot(party_2012, aes(x=cand_party_affiliation, y= party_trans, fill = cand_party_affiliation)) + geom_bar(stat = "identity", width = 0.3) +
  ...
  scale_y_continuous(name='Transactions', labels = scales::scientific) +
  ggtitle('Total Amount of Transactions to 2 Parties from 2011 to 2012')
...
contributions %>% select(transaction_dt)
```
